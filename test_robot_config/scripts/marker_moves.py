...
class ObjMover(object):
    def __init__(self):
        ...
        self.who_moves = rospy.get_param('~who_moves', "marker::base_link")
        self.const_height = rospy.get_param('~heigth', 0.2)
        
        #параметры окружности, вдоль которой движется джентльмен
        self.center = [3, -3.]
        self.radius = 3.
        self.speed = 0.25    # скорость
    ...
    def make_msg(self):
        ...
        self.state_msg.link_name = self.who_moves
        self.state_msg.reference_frame = 'hall::floor'
        ...
        self.state_msg.pose.position.z = self.const_height
