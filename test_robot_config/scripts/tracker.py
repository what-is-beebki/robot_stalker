...
class SingleKFUndirectedObjectTracker(object):
    ...
    def predict(self, t):
        ...
        F = np.array([[1, 0, dt ,0],
                           ...
                           [0, 0, self.k_decay, 0],
                           [0, 0, 0, self.k_decay]])
        #k_decay == 1. Зачем может понадобиться его менять?
...
class RobotKFUndirectedObjectTracker(object):
    ...
    def __init__(self):
        ...
        #штуки которые слушают и вещают координаты распознаваемых объектов
